// Lucide Icons SVG - Apenas os icones mais utilizados
// Fonte: https://lucide.dev/icons
// Todos os icones tem viewBox="0 0 24 24" e stroke-width="2"
...
const LUCIDE_ICONS = {
  ...
  'package': '<path d="m16.5 9.4-9-5.19"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.29 7 12 12 20.71 7"/><line x1="12" x2="12" y1="22" y2="12"/>',
...
// Funcao para renderizar um icone Lucide
function renderLucideIcon(name, size = 18, color = 'currentColor') {
  const iconPath = LUCIDE_ICONS[name];
  if (!iconPath) {
    // Retorna um icone padrao se nao encontrar
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${LUCIDE_ICONS['link']}</svg>`;
  }
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${iconPath}</svg>`;
}
